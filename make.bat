mkdir -p build
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -c -o build\intro.o backgrounds\intro.c
...
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wm-yn"Raptor" -Wm-yc -o main.gbc build\main.o build\intro.o build\hanger.o build\raptor.o build\MchBullet.o build\BravoW1GBC.o build\RaptorMapTilesGBC.o
pause