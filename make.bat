...
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wm-yn"Raptor" -Wm-yc -o main.gbc build\main.o build\commonFunc.o build\spriteHandler.o build\backgroundHandler.o build\title.o build\hanger.o build\raptor.o build\MchBullet.o build\BravoW1GBC.o build\RaptorMapTilesGBC.o
pause